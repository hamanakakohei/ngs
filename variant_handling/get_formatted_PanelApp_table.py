...
df1 = pd.read_table( 'Adult onset dystonia, chorea or related movement disorder.tsv' )
df2 = pd.read_table( 'Ataxia and cerebellar anomalies - narrow panel.tsv' )
df3 = pd.read_table( 'Hereditary ataxia and cerebellar anomalies - childhood onset.tsv' )
df4 = pd.read_table( 'Hereditary ataxia with onset in adulthood.tsv' )
df5 = pd.read_table( 'Hereditary ataxia.tsv' )
